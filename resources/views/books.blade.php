            ...
            @foreach ($books as $item)
                <div class="col-md-6">
                    <div class="card shadow-sm h-100">
                        <img src="https://picsum.photos/400/200?random={{ $loop->index + 1 }}" class="card-img-top"
                        ...
                        <div class="card-body">
                            ...
                            <p class="genre">📚 Genre: {{ $item->genre->name }}</p>
                            <p class="author">✍️ Penulis: {{ $item->author->name }}</p>
                        </div>
                    </div>
                </div>
            @endforeach
